...
grid_search_results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/extratrees/outputs', 'extratrees_results.csv')
...
extratrees_model = ExtraTreesClassifier(n_estimators=100, max_depth=None, random_state=42, n_jobs=-1, min_samples_leaf=1, min_samples_split=2)
