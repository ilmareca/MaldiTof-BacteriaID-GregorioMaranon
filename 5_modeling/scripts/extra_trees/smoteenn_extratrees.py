...
grid_search_results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/extratrees/outputs', 'extratrees_smoteenn_results.csv')
...
# Verify distribution after SMOTEENN
