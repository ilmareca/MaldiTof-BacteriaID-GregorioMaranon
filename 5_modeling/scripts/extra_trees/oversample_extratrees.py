...
grid_search_results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/extratrees/outputs', 'extratrees_oversampling_results.csv')
...
# Verify distribution after oversampling
print("Distribución después de Oversampling:")
print(pd.Series(y_train_resampled).value_counts())

# Define Extra Trees model with specific hyperparameters
extratrees_model = ExtraTreesClassifier(n_estimators=100, max_depth=None, random_state=42, n_jobs=-1)

# Train the model
extratrees_model.fit(X_train_resampled, y_train_resampled)
