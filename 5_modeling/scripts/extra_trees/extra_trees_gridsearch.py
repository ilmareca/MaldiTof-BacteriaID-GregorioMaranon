...
grid_search_results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/extra_trees/outputs', 'grid_search_extra_trees_results.csv')
...
# Define Extra Trees and GridSearch parameters
param_grid = {
