...
grid_search_results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/logistic_regression/outputs', 'smoteenn_logistic_regression_result.csv')
...
# Verificar la distribución después de SMOTEENN
