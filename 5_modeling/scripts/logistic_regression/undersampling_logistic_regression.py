...
grid_search_results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/logistic_regression/outputs', 'undersampling_logistic_regression_result.csv')
...
# Aplicar Undersampling a la clase mayoritaria en el conjunto de entrenamiento
undersample = RandomUnderSampler(random_state=42)
X_train_resampled, y_train_resampled = undersample.fit_resample(X_train, y_train)

# Verificar la distribución después de Undersampling
