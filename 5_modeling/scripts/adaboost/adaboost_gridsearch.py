...
grid_search_results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/adaboost/outputs', 'grid_search_adaboost_results.csv')
...
param_grid = {
    ...
    'estimator__max_depth': [1, 3, 5]  # Ajuste correcto para el árbol base
}

# Initialize AdaBoost classifier with a DecisionTree base learner
