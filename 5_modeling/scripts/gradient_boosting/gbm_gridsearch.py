...
grid_search_results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/gradient_boosting/outputs', 'grid_search_gbm_results.csv')
...
# Define Gradient Boosting and GridSearch parameters
param_grid = {
