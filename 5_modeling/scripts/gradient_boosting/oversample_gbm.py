...
grid_search_results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/gradientboosting/outputs', 'gradientboosting_oversampling_results.csv')
...
# Define Gradient Boosting model with specific hyperparameters
