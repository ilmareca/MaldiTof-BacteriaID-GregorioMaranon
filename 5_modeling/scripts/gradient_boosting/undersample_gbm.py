...
grid_search_results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/gradientboosting/outputs', 'gradientboosting_undersampling_results.csv')
