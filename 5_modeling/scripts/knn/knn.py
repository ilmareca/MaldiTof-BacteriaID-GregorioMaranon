...
grid_search_results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/knn/outputs', 'knn_results.csv')
log_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/knn/outputs', 'knn_log.txt')
...
def train_and_evaluate(X_train, y_train, X_test, y_test, method):
    print(f"Training KNN model with {method}...")
