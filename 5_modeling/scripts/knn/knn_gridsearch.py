...
grid_search_results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/knn/outputs', 'grid_search_knn_results.csv')
...
# Define KNN and GridSearch parameters
param_grid = {
