...
grid_search_results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/random_forest/outputs', 'raw_umap_random_forest_gridsearch.csv')
...
# UMAP components to test
umap_components = [10, 50, 100, 500, 1000, 2000, 3000, 4000, 5000]
...
for n_components in umap_components:
    print(f"\nApplying UMAP with {n_components} components...")
...
print(f"Grid Search results with UMAP saved to {grid_search_results_file}")
