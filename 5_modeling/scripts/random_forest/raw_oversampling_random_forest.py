...
grid_search_results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/random_forest/outputs', 'raw_oversampling_random_forest_gridsearch.csv')
...
print(f"Grid Search results with oversampling saved to {grid_search_results_file}")
