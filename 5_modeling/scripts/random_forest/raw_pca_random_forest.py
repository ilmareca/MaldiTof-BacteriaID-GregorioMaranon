...
grid_search_results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/random_forest/outputs', 'raw_pca_random_forest_gridsearch.csv')
...
pca_components = [10, 50, 100, 500, 1000, 2000, 3000, 4000, 5000]
...
print(f"Grid Search results with PCA saved to {grid_search_results_file}")
