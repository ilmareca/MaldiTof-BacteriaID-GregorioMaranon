...
results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/lightgbm/outputs', 'lightgbm_undersampling_results.csv')
...
write_log("Applied RandomUnderSampler to balance the training dataset.")
