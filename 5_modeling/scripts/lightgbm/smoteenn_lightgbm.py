...
results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/lightgbm/outputs', 'lightgbm_smoteenn_results.csv')
...
write_log("Applied SMOTEENN to balance the training dataset.")
