...
results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/lightgbm/outputs', 'lightgbm_oversampling_results.csv')
...
write_log("Applied RandomOverSampler to balance the training dataset.")
write_log(f"New class distribution: {pd.Series(y_train_resampled).value_counts().to_dict()}")
