...
results_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/5_modeling/scripts/lightgbm/outputs', 'lightgbm_smote_results.csv')
...
write_log("Applied SMOTE to balance the training dataset.")
