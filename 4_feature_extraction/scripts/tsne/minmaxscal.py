...
output_dir = '/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/preprocessing/2d-visual/tsne/minmaxscal'
...
df_spectra = pd.DataFrame({'extern_id': y_sample, 'spectrum': list(X_scaled)})
...
for antibiotic in antibiotics:
    ...
    if n_samples <= 1:
        ...
        continue
    perplexity = min(5, n_samples // 3)  # Valores bajos de perplexity debido a la alta dimensión
