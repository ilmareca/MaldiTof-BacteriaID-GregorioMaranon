...
output_dir = '/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/4_feature_extraction/scripts/lle/figures/minmax_corr'
score_output_file = os.path.join('/export/usuarios01/ilmareca/github/MaldiTof-BacteriaID-GregorioMaranon/4_feature_extraction/scripts/lle/outputs', 'lle_minmax_corr_grid.csv')
...
n_neighbors_list = [5, 10, 15, 30]  # Different neighborhood sizes
n_components_list = [2]  # Number of components for LLE (usually 2 for visualization)
    ...
    for threshold in threshold_list:
        ...
        for n_neighbors in n_neighbors_list:
            for n_components in n_components_list:
                ...
                file_name = f'lle_{safe_antibiotic_name}_n{n_neighbors}_thresh{threshold}.png'
